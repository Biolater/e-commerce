      ...
      <div className="container h-full px-4 py-2 mx-auto">
        <div className="navbar__mobile w-full h-full flex items-center justify-between md:hidden">
          ...
          <div className="auth__buttons text-white font-semibold flex items-center gap-2">
            <Link href="/login" className="bg-secondary active:scale-90  border-2 border-[#2D4263] hover:bg-transparent button-transition rounded-[5px] px-[10px] py-[5px]">
              Login
            </Link>
            <Link href="/signup" className="bg-tertiary active:scale-90 border-2 border-[#C84B31] hover:bg-transparent button-transition rounded-[5px] px-[10px] py-[5px]">
              Sign up
            </Link>
          </div>
        </div>
